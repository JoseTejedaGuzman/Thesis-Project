...
UnderwaterTestApp::UnderwaterTestApp(std::string dataDirPath, sf::RenderSettings s, sf::HelperSettings h, UnderwaterTestManager* sim)
    : GraphicalSimulationApp("Underwater Test", "/home/external-holo/stonefish/SimTry2/Simulation/UnderWaterTestManager.cpp", s, h, sim)
{
}
...
/*
  ...
  */  
    ...
    */
    ...
    option = getGUI()->DoComboBox(id, 180.f, 200.f, 150.f, "Girona500", option, "Trackball center");*/
