...
void UnderwaterTestManager::BuildScenario()
{
    ...
    getOcean()->AddVelocityField(new sf::Jet(sf::Vector3(0,0,0.8), sf::VY(), 0.3, 5.0));
    getOcean()->AddVelocityField(new sf::Uniform(sf::Vector3(0.8,0.0,0.0)));
    getOcean()->EnableCurrents();
    getAtmosphere()->SetupSunPosition(40.0, 20.0);
    ...
    sf::Obstacle* sphere1 = new sf::Obstacle("Sph", 0.5, sf::I4(), "Fiberglass", "yellow");
    AddStaticEntity(sphere1, sf::Transform(sf::Quaternion(0,M_PI_2,0), sf::Vector3(7.0,2.0,5.0)));
    sf::Obstacle* sphere2 = new sf::Obstacle("Sph2", 0.5, sf::I4(), "Fiberglass", "yellow");
    AddStaticEntity(sphere2, sf::Transform(sf::Quaternion(0,M_PI_2,0), sf::Vector3(7.0,-2.0,5.0)));

    sf::Obstacle* box = new sf::Obstacle("Box", sf::Vector3(0.3, 0.3, 0.3), sf::I4(), "Rock", "grey");
    AddStaticEntity(box, sf::Transform(sf::Quaternion(0,M_PI_2,0), sf::Vector3(5.0,-2.0,5.0)));
    sf::Obstacle* box2 = new sf::Obstacle("Box2", sf::Vector3(0.3, 0.3, 0.3), sf::I4(), "Rock", "grey");
    AddStaticEntity(box2, sf::Transform(sf::Quaternion(0,M_PI_2,0), sf::Vector3(5.0,2.0,5.0)));

    sf::Obstacle* box3 = new sf::Obstacle("Box", 0.5, sf::I4(), "Rock", "yellow");
    AddStaticEntity(box3, sf::Transform(sf::Quaternion(0,M_PI_2,0), sf::Vector3(3.0,-3.0,5.0)));
    sf::Obstacle* box4 = new sf::Obstacle("Box2", 0.5, sf::I4(), "Rock", "yellow");
    AddStaticEntity(box4, sf::Transform(sf::Quaternion(0,M_PI_2,0), sf::Vector3(3.0,3.0,5.0)));
    sf::Obstacle* box5 = new sf::Obstacle("Box5", 0.5, sf::I4(), "Rock", "yellow");
    AddStaticEntity(box5, sf::Transform(sf::Quaternion(0,M_PI_2,0), sf::Vector3(4.5,4.0,6.0)));

    sf::Obstacle* wall = new sf::Obstacle("Wall_2", sf::Vector3(10,0.5,25.0), sf::I4(), "Rock", "grey");
    AddStaticEntity(wall, sf::Transform(sf::Quaternion(0,M_PI_2,0), sf::Vector3(5.0,-6.0,5.0)));
    sf::Obstacle* wall_s = new sf::Obstacle("Wall", sf::Vector3(10,0.5,25.0), sf::I4(), "Rock", "grey");
    AddStaticEntity(wall_s, sf::Transform(sf::Quaternion(0,M_PI_2,0), sf::Vector3(5.0,6.0,5.0)));
    ...
    sf::FLS* fls = new sf::FLS("FLS", 256, 500, 150.0, 30.0, 1.0, 30.0, sf::ColorMap::GREEN_BLUE);
    fls->setNoise(0.05, 0.05);
    //fls->setDisplayOnScreen(true, 800, 250, 0.4f);
    sf::SSS* sss = new sf::SSS("SSS", 800, 400, 70.0, 1.5, 50.0, 1.0, 40.0, sf::ColorMap::GREEN_BLUE);
    sss->setDisplayOnScreen(true, 500, 15, 0.8f);
    //sf::MSIS* msis = new sf::MSIS("MSIS", 1.5, 500, 2.0, 30.0, -50, 50, 1.0, 100.0, sf::ColorMap::GREEN_BLUE);
    //msis->setDisplayOnScreen(true, 880, 455, 0.8f);
    ...
    thHeaveS->setSetpoint(0.55);
    thHeaveB->setSetpoint(0.55);
    thSurgeP->setSetpoint(0.15);
    //thSurgeS->setSetpoint(0.55);
